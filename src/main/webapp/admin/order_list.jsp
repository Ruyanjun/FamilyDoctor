...
<div class="container-fluid">
    ...
    <ul role="tablist" class="nav nav-tabs">
        ...
        <li <c:if test="${ostatus==3 }">class="active"</c:if> role="presentation"><a href="order_list.action?pageNumber=1&ostatus=3">合作中</a></li>
            ...
            <tr>
                ...
                <td>
                    <p>
                        ...
                        <c:if test="${order.ostatus==3 }"><span style="color:green;">已签约</span></c:if>
                ...
                <td>
                    <c:if test="${order.ostatus==2 }">
                        <a class="btn btn-success" href="order_status_change.action?oid=${order.oid}&ostatus=3">签约</a>
                    </c:if>
